...
import image23 from './assets/slide22.png';
import image24 from './assets/slide23.png';
...
const slidesData = [
  ...
  { image: image15, text: 'Заповни дані нового курсу і клікни "Save"', tipClass: 'tip15', btnClass: 'btn15' },
  ...
  { image: image20, text: 'Фільтр "Курс" - виставляється автоматично. Фільтр "Тип уроку" - обери тип уроку', tipClass: 'tip20', btnClass: 'btn20' },
  { image: image22, text: 'Стають доступними слоти із часом, обираємо потрібний', tipClass: 'tip22', btnClass: 'btn22' },
  { image: image23, text: 'Після того, як обрали - натискаємо "Create"', tipClass: 'tip23', btnClass: 'btn23' },
  { image: image24, text: 'Обираємо ментора на заміну, пишемо потрібний коментар і натискаємо "Save"', tipClass: 'tip24', btnClass: 'btn24' },
